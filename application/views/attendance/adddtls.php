          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header bg-secondary">
                <h3 class="card-title">Please Add Attendance Of <?=$date?></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
			  ...
			  <div class="card-body">
			   ...
			   <div class="form-group">
                  ...
                  <input type="text" class="datepicker form-control" id="doa" placeholder="Enter Date Of Attendance" name="doa" autocomplete="off" value="<?=$date?>" readonly />
                </div>
			   ...
			   <table id="example1" class="table table-bordered">
                ...
                <tr>
				  ...
				  <label>
					<input type="radio" class="minimal" name="attendance[<?=$r->st_id?>]" value="L" <?php if(in_array($r->st_id,$leave)){echo 'checked';}?>/> Leave										
                  </label>				  
