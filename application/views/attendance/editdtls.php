            ...
            <div class="card card-primary">
			  ...
			  <div class="card-body">
				...
				<div class="form-group">
                  ...
                  <input type="text" class="datepicker form-control" id="doa" placeholder="Enter Date Of Attendance" name="doa" autocomplete="off" value="<?=date('d-M-Y',strtotime($r->a_doa))?>"  />
                </div>
