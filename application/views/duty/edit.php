  ...
  <div class="content-wrapper">
	...
	<?php $this->load->view('template/message');?>	
      <div class="container-fluid">
         ...
         <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
			  ...
			  <form role="form" action="<?php echo site_url('Duty/updateDutyDtls');?>" method="post">
			  <div class="card-body">
        <style>
        .table td, .table th
        {
        ...
        $e_SI_assign=0;
        $e_ASI_assign=0; 
        $e_Constable_assign=0;
        $e_Civic_assign=0;

        foreach($event as $r) { 

        $e_Insp_assign=$r->e_Insp_assign;
        $e_SI_assign=$r->e_SI_assign;
        $e_ASI_assign=$r->e_ASI_assign; 
        $e_Constable_assign=$r->e_Constable_assign;
        $e_Civic_assign=$r->e_Civic_assign;
        ...
        ?>
          ...
          <td><?=$e_Insp_assign?></td>		  
					<td><?=$e_SI_assign?></td>	
          <td><?=$e_ASI_assign?></td>	
          <td><?=$e_Constable_assign?></td>	
          <td><?=$e_Civic_assign?></td>	
				</tr>
				<?php }?>				
				</tbody>
				</table>	
                 ...
                 <?=$r->stname?>
                  ...
                  <div class="form-group clearfix">
                      <div class="icheck-primary d-inline">
                        <input type="checkbox" id="<?=$r->st_id?>" name="staff[]" value="<?=$r->st_id?>"value="<?=$r->st_id?>" <?=in_array($r->st_id,$dutyassign)?'checked':''?>>
                        <label for="<?=$r->st_id?>">
                        Assign
                        </label>
                      </div>
        ...
        <table id="example1" class="table table-bordered">
                ...
                <tr>
                 ...
                 <?=$r->stname?>
                  ...
                  <div class="form-group clearfix">
                      <div class="icheck-primary d-inline">
                        <input type="checkbox" id="<?=$r->st_id?>" name="staff[]" value="<?=$r->st_id?>" <?=in_array($r->st_id,$dutyassign)?'checked':''?>>
                        <label for="<?=$r->st_id?>">
                        Assign
                        </label>
                      </div>
