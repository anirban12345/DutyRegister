        ...
        <!-- Info boxes -->
         <div class="row">
          ...
          <div class="col-md-12">
            ...
            <form action="<?=base_url('Duty/loDutyReportdtls')?>" method="post">
            <div class="card card-primary">
                <div class="card-header bg-secondary">
                  <h3 class="card-title"><?=$bread?></h3>
                </div>
                <div class="card-body"> 
                <div class="row">
                    <div class="col-6">
                  <div class="form-group">
                        <label for="d_date_from">Date From</label>
                          <div class="input-group date" id="d_date_from" data-target-input="nearest">
                              <input type="text" class="form-control datetimepicker-input" data-target="#d_date_from" name="d_date_from" autocomplete="off" required />
                  ...
                  <div class="form-group">
                        <label for="d_date_to">Date To</label>
                          <div class="input-group date" id="d_date_to" data-target-input="nearest">
                              <input type="text" class="form-control datetimepicker-input" data-target="#d_date_to" name="d_date_to" autocomplete="off" required />
                ...
                <div class="card-footer">
                    <button type="submit" name="action" value="create" class="btn btn-primary btn-raised btn-sm">View Report</button>
                </div>
            </div>
            </form>
