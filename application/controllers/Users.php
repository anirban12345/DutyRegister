...
class Users extends Admin_Controller 
{
    ...
    public function getUsers()
	{
		...
		foreach($users as $r)
		{
            ...
            $sub_array[] = '<a role="button" href="'.base_url('Users/manage?q='.urlencode($this->encrypt->encode($r->u_id))).'" class="btn btn-info btn-sm waves-effect waves-light"><i class="fas fa-edit"></i> Manage</a>';                            
			$data[] = $sub_array;
		}
